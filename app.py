...
with tab_pred:
    ...
    if st.session_state.result:
        ...
        with col_btn2:
            ...
            if st.button("Nuovo Ticket", key="new_ticket", width='stretch'):
...
with tab_metrics:
    ...
    with st.expander("🔍 Visualizza Metriche Raw (per Report)", expanded=False):
        ...
        if cat_data:
            ...
            st.dataframe(df_cat_metrics, hide_index=True, width='stretch')
        ...
        if pri_data:
            ...
            st.dataframe(df_pri_metrics, hide_index=True, width='stretch')
